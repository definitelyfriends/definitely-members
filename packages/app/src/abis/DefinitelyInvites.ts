const abi = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "inviteCooldown_", type: "uint256" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "AlreadyDefMember", type: "error" },
  { inputs: [], name: "InviteOnCooldown", type: "error" },
  { inputs: [], name: "NoInviteToClaim", type: "error" },
